...
export default defineConfig({
  testDir: "./tests", testMatch: /(?:events-(?:api|admin|public|calendar)|wallet-guide|notices|collection|center-status|browser-security|markdown-editor|custom-controls|locale-detection|admin-dialogs|space-tour|navigation-(?:feedback|indicator))\.spec\.ts/,
