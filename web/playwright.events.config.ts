...
export default defineConfig({
  testDir: "./tests", testMatch: /(?:events-(?:api|admin|public|calendar)|wallet-guide|notices|browser-security|markdown-editor|custom-controls|locale-detection|admin-dialogs)\.spec\.ts/,
