...
- Wallet guide step actions align as a group to the right edge of the panel content in every step, including wrapped mobile rows. Preserve the previous/next order and the shared button sizes, gaps and keyboard behavior.
